...
class RouteGenerator{
  static Route<dynamic> generateRoute(RouteSettings settings){
    switch (settings.name){
      case '/z':return MaterialPageRoute(builder: (context)=> const LoginPage() ) ;
      ...
      case '/': return MaterialPageRoute(builder: (context) =>  ScanDevicesPage(), settings:const RouteSettings(name: '/scan_devices'));
